...
export function createWorld(scene){
 ...
 function caseBox(x,z,w,h,d,top){box(w,h,d,x,top+h/2,z,glass,exhibits);for(const xx of [-w/2,w/2])for(const zz of [-d/2,d/2])box(.018,h,.018,x+xx,top+h/2,z+zz,brass,exhibits);box(w+.025,.025,d+.025,x,top+h,z,brass,exhibits);}
